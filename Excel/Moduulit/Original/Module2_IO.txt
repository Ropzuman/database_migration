...
Sub TyhjaaKommentit()
Attribute TyhjaaKommentit.VB_Description = "Macro recorded 13.2.2002 by Grˆnroos Ville"
Attribute TyhjaaKommentit.VB_ProcData.VB_Invoke_Func = " \n14"
    Cells.ClearComments
End Sub
Sub HaeDocTiedot()
Dim i As Integer
...
'Dim Row As Range
  Sheets(Sheet).Select
  With ActiveSheet
    For i = 1 To .Comments.Count 'K‰yd‰‰n l‰pi kaikki kommentit
...
'  SVRivi = CInt(ActiveSheet.HPageBreaks(Vaihto).Location.Row)
  'Automaattinen rivinvaihto tuli huonoon kohtaan, joten tehd‰‰n itse uusi edelliseen sopivaan paikkaan
...
VirheSivunLuvussa:
  'Rivinvaihto tuli juuri nappiin kohtaan, vahvistetaan se viel‰
